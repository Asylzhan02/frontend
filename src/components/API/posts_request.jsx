              ...
              <div className="post-content">
                <h3 className="post-title">
                  <a href="#"><div dangerouslySetInnerHTML={{ __html: props.title }} />{props.published
                    ?
                    <>
                    <h6 style={{ color:'green'}}>Жариялауға жіберілді<VerifiedIcon/></h6>
                ...
                <Link  to={`/post/${props.id}`} className="read-more">Оқу</Link>
                <CardContent/>
                <Divider variant="middle" />
                <CardContent/>
                    ...
                    <Button color="error" variant="outlined" startIcon={<FavoriteBorderTwoToneIcon />} onClick={() =>LikeAdd(props.id)}/>
                        ...
                        >
                          ...
                          <DialogContent>
                            ...
                            Егер сіз жазбаны жойсаңыз ол ақырындап жойылады
                            </DialogContentText>
                          </DialogContent>
                          <DialogActions>
                            <Button onClick={handleClose}>Бас тарту</Button>
