...
function handleDeleteElement (id) {
  ...
  const scrollHandler=(e)=>{
    ...
    <ServerError title={" Сервер қате!"} error_text={"Сервер сұрауларға жауап бермейді. Егер сіз бұл хабарламаны көрген болсаңыз, бетті қайта жүктей аласыз.Егер ол көмектеспесе бізге жазыңыз"}/>
      :
