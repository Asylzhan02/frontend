...
const UserPost = observer(() => {
  ...
  useEffect(() => {
    setLoading(true);
    axiosApiInstance
      .get(`${url.baseUrl}${url.Profile.userpost}`, {
              ...
              {lenght ? (
                ...
                <Card variant="outlined">
                  <Container>
                    <Stack spacing={2}>
                      <EditOffTwoToneIcon
                        className="center_icons"
                        sx={{ fontSize: 40 }}
                      />
                      <h2 className="center">Сізде жазба жоқ</h2>
                      <Alert severity="info">
                        <AlertTitle>Жазбалар</AlertTitle>
                        Егер сіз хабарлама жазсаңыз оны әкімші қарайды —{" "}
                        <strong> 2 сағат пен 1 күн аралығында!</strong>
                      </Alert>
                      <Button
                        variant="outlined"
                        className="center"
