...
<div className="container_search">
     <h4 className="data_lenght"> Табылғандар {this.state.result_length}</h4>
        <input
        ...
        <div className="null_data"> Бұл хабарлама жоқ.<TextAnim text_main="Өкінішке орай бізде мұндай мақала жоқ" width="38"/></div>
